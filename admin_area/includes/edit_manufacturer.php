...
if (isset($_POST['update_manufacturer'])) {
    ...
    $manufacturer_image = $_REQUEST["photo_old"];
    if (isset($_FILES['manufacturer_image']) && $_FILES['manufacturer_image']['name'] != "") {
...
<div class="card rounded">
	<div class="card-header bg-light h5"><i class="fas fa-plus-square"></i> Update Manufacturer</div>
	<div class="card-body">
		<div class="row">
			<div class="col-md-8 offset-md-2">
				<form method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
				  ...
				  <div class="form-row mb-3">
					...
					<div>
					<input type="hidden" name="photo_old" value="<?php echo $manufacturer_image; ?>">
					</div>
				    <div class="col-md-9">
				    	<input type="file" name="manufacturer_image" id="manufacturer_image" placeholder="Category Title">
				      <div class="invalid-feedback">
				  ...
				  <div class="row">
				  	<div class="col-12 mt-4">
				  		<button class="btn btn-info form-control" name="update_manufacturer" type="submit"><i class="fas fa-plus-circle"></i> Update Manufacturer</button>
				  	</div>
				  </div>
				</form>
			</div>
